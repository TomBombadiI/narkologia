...
[...offcanvasElementList].map(offcanvasEl => new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Offcanvas(offcanvasEl));
// === НАСТРОЙКИ ===
    ...
    function runWave() {
        spans.forEach((span, index) => {
            setTimeout(() => {
                ...
                span.addEventListener('animationend', () => span.classList.remove('wave-letter'), { once: true });
            }, index * letterDelay);
        });
...
new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.reviews__slider', {
    autoplay: {
        delay: 2000,
    },
    loop: true,
